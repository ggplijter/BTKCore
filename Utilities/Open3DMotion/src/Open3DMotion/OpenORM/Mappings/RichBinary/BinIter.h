...
namespace Open3DMotion
{
	...
	protected:
		template<typename DataType> static const DataType* GetFieldPointer(const RichBinary& bin, const char* fieldname, size_t dimension) noexcept(false)
		{
	...
	{
	public:
		BinConstIter1(const RichBinary& bin, const char* fieldA, size_t dimA) noexcept(false) :
			BinIterBase(bin),
	...
	{
	public:
		BinIter1(RichBinary& bin, const char* fieldA, size_t dimA)  noexcept(false) :
	...
	{
	public:
		BinConstIter2(const RichBinary& bin, const char* fieldA, size_t dimA, const char* fieldB, size_t dimB) noexcept(false) :
				BinConstIter1<TypeA> (bin, fieldA, dimA),
	...
	{
	public:
		BinIter2(const RichBinary& bin, const char* fieldA, size_t dimA, const char* fieldB, size_t dimB) noexcept(false) :
	...
	{
	public:
		BinConstIter3(const RichBinary& bin, const char* fieldA, size_t dimA, const char* fieldB, size_t dimB, const char* fieldC, size_t dimC) noexcept(false) :
				BinConstIter2<TypeA, TypeB> (bin, fieldA, dimA, fieldB, dimB),
	...
	{
	public:
		BinIter3(const RichBinary& bin, const char* fieldA, size_t dimA, const char* fieldB, size_t dimB, const char* fieldC, size_t dimC) noexcept(false) :
