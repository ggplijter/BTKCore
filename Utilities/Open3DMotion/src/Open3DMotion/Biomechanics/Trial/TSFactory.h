...
namespace Open3DMotion
{
	...
	{
	public:
		TSScalarConstIter(const TimeSequence& ts) noexcept(false)  :
	...
	{
	public:
		TSScalarIter(TimeSequence& ts) noexcept(false)  :
	...
	{
	public:
			TSVector3ConstIter(const TimeSequence& ts) noexcept(false) :
	...
	{
	public:
		TSVector3Iter(TimeSequence& ts) noexcept(false)  :
	...
	{
	public:
			TSOccVector3ConstIter(const TimeSequence& ts) noexcept(false) :
	...
	{
	public:
		TSOccVector3Iter(TimeSequence& ts) noexcept(false)  :
	...
	{
	public:
		TSOccConstIter(const TimeSequence& ts) noexcept(false)  :
	...
	{
	public:
		TSOccIter(TimeSequence& ts) noexcept(false)  :
	...
	{
	public:
			TSOccMatrix3x3ConstIter(const Open3DMotion::TimeSequence& ts) noexcept(false) :
	...
	{
	public:
			TSOccMatrix3x3Iter(Open3DMotion::TimeSequence& ts) noexcept(false) :
